...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DopplerCache) DeepCopyInto(out *DopplerCache) {
	*out = *in
	if in.Enable != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DopplerCache.
func (in *DopplerCache) DeepCopy() *DopplerCache {
	if in == nil {
		return nil
	}
	out := new(DopplerCache)
	in.DeepCopyInto(out)
	return out
}
